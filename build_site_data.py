...
QUADRANT_COPY = {
    ...
    "high-fragmented": {
        ...
        "why": "When a job is broadly similar across companies but not exactly, a "
               "horizontal agent captures the surface. Most admin and secretary work "
               "falls here, the largest unclaimed cell and the one the labs have a real "
               "shot at.",
