...
The problem however is that the operational context doesn't transfer to the labs. The deployments confirm this. [Anthropic's deal with FIS for the Financial Crimes AI agent](https://www.fisglobal.com/about-us/media-room/press-release/2026/fis-brings-agentic-ai-to-banking-with-anthropic-starting-with-financial-crimes) states that operational context, what counts as suspicious activity at BMO versus Amalgamated, which alerts get escalated, how investigators document findings, stays with FIS. [OpenAI Frontier](https://openai.com/index/introducing-openai-frontier/) is structured the same way, launching with vertical AI startups as Frontier Partners rather than competitors. The labs provide the models underneath. The operational context lives somewhere else.
